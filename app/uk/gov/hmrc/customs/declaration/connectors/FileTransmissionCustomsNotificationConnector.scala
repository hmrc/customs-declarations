...
import uk.gov.hmrc.customs.declaration.services.{DeclarationsConfigService, FileTransmissionCustomsNotification}
...
class FileTransmissionCustomsNotificationConnector @Inject()(http: HttpClient,
  ...
  def send(notification: FileTransmissionCustomsNotification): Future[Unit] = {
