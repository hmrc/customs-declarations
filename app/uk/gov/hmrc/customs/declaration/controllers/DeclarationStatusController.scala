...
class DeclarationStatusController @Inject()(val shutterCheckAction: ShutterCheckAction,
 ...
 class TestLogController@Inject()(val logger: DeclarationsLogger,
   ...
   def get(): Action[AnyContent] = Action {
     ...
     Logger(getClass()).info("""json{"conversationId":"uvxyz","requestedApiVersion":"1.0","clientId":"abc123","authorisedAs":"NonCsp(GB123)","message":"Declaration request processed successfully"}""")
     Logger(getClass()).info("""json{"conversationId":"uvxyz","requestedApiVersion":"1.0","clientId":"abc123","authorisedAs":"NonCsp(GB123)","message":"Outbound call duration was [30] ms"}""")
     Ok
   }
 }
