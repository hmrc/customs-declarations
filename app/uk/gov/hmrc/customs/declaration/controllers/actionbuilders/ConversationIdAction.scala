...
/** Action builder that transforms a `Request` to a `CorrelationIdsRequest`
  ...
  */
@Singleton
class ConversationIdAction @Inject()(correlationIdService: UniqueIdsService, logger: DeclarationsLogger) extends ActionTransformer[Request, ConversationIdRequest] {
