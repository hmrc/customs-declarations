...
object AppDependencies {
  ...
  val playJsonJoda          = "com.typesafe.play"                          %% "play-json-joda"       % "2.10.0-RC7"
  val simpleReactiveMongo   = "uk.gov.hmrc"                                %% "simple-reactivemongo" % "8.1.0-play-28"
  val reactiveMongoTest     = "uk.gov.hmrc"                                %% "reactivemongo-test"   % "5.1.0-play-28" % testScope
