...
object AppDependencies {
  ...
  private val customs_api_common_version = "1.57.1"
  ...
  val customsApiCommon      = "uk.gov.hmrc"                                %% "customs-api-common"      % customs_api_common_version   withSources()
  val customsApiCommonTests = "uk.gov.hmrc"                                %% "customs-api-common"      % customs_api_common_version   % testScope classifier "tests"
