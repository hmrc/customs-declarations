...
import uk.gov.hmrc.customs.declaration.services.{BusinessServiceImpl, XmlValidationService}
...
class CustomsDeclarationControllerSpec extends UnitSpec
  ...
  trait SetUp extends AuthConnectorStubbing {
    ...
    protected val mockBusinessService: BusinessServiceImpl = mock[BusinessServiceImpl]
