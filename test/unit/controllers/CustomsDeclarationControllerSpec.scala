...
class CustomsDeclarationControllerSpec extends UnitSpec
  ...
  trait SetUp extends AuthConnectorStubbing {
    ...
    protected val headerValidator = new HeaderWithAcceptValidator(mockLogger)
    ...
    protected val stubValidateAndExtractHeadersAction: ValidateAndExtractHeadersAction = new ValidateAndExtractHeadersAction(new HeaderWithAcceptValidator(mockLogger), mockLogger)
