...
import uk.gov.hmrc.customs.declaration.controllers.actionbuilders.{HeaderWithAcceptValidator, ValidateAndExtractHeadersAction}
...
class ValidateAndExtractHeadersActionSpec extends UnitSpec with MockitoSugar with TableDrivenPropertyChecks {
  ...
  trait SetUp {
    ...
    val mockHeaderValidator: HeaderWithAcceptValidator = mock[HeaderWithAcceptValidator]
