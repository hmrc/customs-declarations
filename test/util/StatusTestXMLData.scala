...
object StatusTestXMLData {
  ...
  val ValidImportProcedureCategory: String = "40"
  val ValidExportProcedureCategory: String = "10"
  val InValidProcedureCategory: String = "99"
  ...
  def generateDeclarationManagementInformationResponse(receivedDate: String,  tradeMovementType: String, procedureCategory: String, communicationAddress: String = validCommunicationAddress): NodeSeq = <n1:queryDeclarationInformationResponse xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd_1="http://trade.core.ecf/messages/2017/03/31/" xmlns:n1="http://gov.uk/customs/retrieveDeclarationInformation/v1" xmlns:tns="http://cmm.core.ecf/BaseTypes/cmmPartyTypes/trade/2017/02/22/" xmlns:n2="http://cmm.core.ecf/BaseTypes/cmmServiceTypes/trade/2017/02/22/" xmlns:n3="http://cmm.core.ecf/BaseTypes/cmmDeclarationTypes/trade/2017/02/22/" xmlns:tns_3="http://cmm.core.ecf/BaseTypes/cmmEnhancementTypes/trade/2017/02/22/" xsi:schemaLocation="http://gov.uk/customs/retrieveDeclarationInformation/v1 queryDeclarationInformationResponse.xsd">
    <n1:responseCommon>
      <n1:processingDate>2001-12-17T09:30:47Z</n1:processingDate>
    </n1:responseCommon>
    <n1:responseDetail>
