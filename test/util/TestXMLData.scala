...
object TestXMLData {
  ...
  val ValidMultiFileUploadXml: Elem = <FileUploadRequest xmlns="hmrc:fileupload2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="hmrc:fileupload2 FileUploadRequest.xsd ">
