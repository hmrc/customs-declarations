...
object TestXMLData {
  ...
  val InvalidCancellationXML = <md:MetaData xmlns="urn:wco:datamodel:WCO:DEC-DMS:2" xmlns:md="urn:wco:datamodel:WCO:DocumentMetaData-DMS:2">
    <md:WCODataModelVersionCode>3.6</md:WCODataModelVersionCode>
    <md:WCOTypeName>DEC</md:WCOTypeName>
    <md:ResponsibleCountryCode>NL</md:ResponsibleCountryCode>
    <md:ResponsibleAgencyName>Duane</md:ResponsibleAgencyName>
  ...
  val DeclarationStatusOkResponse =
      ...
      <n1:responseDetail>
        <n1:declarationManagementInformationResponse>
          ...
          <xsd_1:declaration>
            ...
            <n3:goodsItemCount>0</n3:goodsItemCount>
            <n3:communicationAddress>String</n3:communicationAddress>
